...
#define TAM_MAX_JANELA 5  // Tamanho da janela da Janela Deslizante
...
// Diferente do anterior por conta da janela deslizante
// RETORNO TAM_MAX_JANELA - TODOS DA JANELA RECEBERAM ACK
// 0 <= RETORNO < TAM_MAX_JANELA - INDICE DO FRAME QUE RECEBEU NACK 
// RETORNO -1 - ERRO (ALGUMA FUNCAO)
// RETORNO TAM_MAX_JANELA + 1 - ERRO (ENVIAR FRAME ERRO)
int wait_ack_deslizante(int sockfd, frame_t *frame_envio, int tempo_timeout, int indiceJanela);
